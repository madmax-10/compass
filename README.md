...
3. Start Docker before running any `docker` or `docker compose` command:
...
4. (Linux) Optional but recommended: enable Docker to start on boot: `sudo systemctl enable docker`.
